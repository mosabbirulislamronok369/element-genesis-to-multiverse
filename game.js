...
// The generator NEVER reuses the exact same factual question inside a sub-category.
const UNIQUE_STEMS=[
  'Recall checkpoint: {q}',
...
window.__ELEMENT_GAME_V19_READY=true;

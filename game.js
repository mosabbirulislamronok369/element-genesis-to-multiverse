...
const GAME_RECIPE_LIBRARY={
  'Fire':{field:'energy',correct:'Wood + Heat',wrong:['Steam + Wood','Glass + Stone','Salt + Metal','Magnet + Paper']},
  'Stone Shelter':{field:'survival engineering',correct:'Stone + Wood + Rope',wrong:['Paper + Magnet','Glass + Salt','Copper + Oil','Steam + Cloth']},
  'Stone Axe':{field:'toolmaking',correct:'Stone + Wooden Handle',wrong:['Paper + Water','Glass + Steam','Iron Wire + Oil','Salt + Cloth']},
  'Spear':{field:'toolmaking',correct:'Sharpened Stone + Wood',wrong:['Glass + Paper','Copper + Water','Magnet + Clay','Steam + Rope']},
  'Wheel':{field:'mechanical engineering',correct:'Round Disc + Axle',wrong:['Flat Plate + Rope','Magnet + Paper','Steam + Stone','Glass + Salt']},
  'Pottery':{field:'materials',correct:'Clay + Heat',wrong:['Wood + Magnet','Stone + Steam','Iron + Water','Paper + Oil']},
  'Bronze Tool':{field:'metallurgy',correct:'Copper + Tin + Heat',wrong:['Iron + Oxygen','Gold + Water','Stone + Steam','Wood + Salt']},
  'Iron Tool':{field:'metallurgy',correct:'Iron + Carbon + Heat',wrong:['Copper + Tin','Wood + Water','Glass + Paper','Salt + Magnet']},
  'Water Mill':{field:'mechanical energy',correct:'Flowing Water + Wheel',wrong:['Dry Wood + Fire','Magnet + Paper','Steam + Clay','Salt + Stone']},
  'Tesla Coil':{field:'electromagnetism',correct:'Coil + High-Frequency Current',wrong:['Clay + Water','Wood + Salt','Stone + Steam','Paper + Magnet']},
  'Telegraph':{field:'communication',correct:'Battery + Wire + Signal Key',wrong:['Lens + Mirror','Steam + Wheel','Clay + Fire','Magnet + Paper']},
  'Electric Motor':{field:'electrical engineering',correct:'Magnet + Coil + Current',wrong:['Stone + Water','Paper + Heat','Salt + Wood','Glass + Steam']},
  'Radio':{field:'wireless communication',correct:'Oscillator + Antenna + Receiver',wrong:['Wheel + Rope','Clay + Fire','Stone + Salt','Paper + Magnet']},
  'Vacuum Tube Computer':{field:'early computing',correct:'Vacuum Tubes + Logic Circuits',wrong:['Wood + Water','Clay + Rope','Magnet + Paper','Glass + Salt']},
  'Early Computer':{field:'computing',correct:'Electronic Switches + Memory + Logic',wrong:['Steam + Wheel','Stone + Rope','Paper + Magnet','Salt + Glass']},
  'Transistor':{field:'semiconductor electronics',correct:'Semiconductor + Doped Junction',wrong:['Copper + Water','Wood + Heat','Clay + Magnet','Paper + Salt']},
  'Integrated Circuit':{field:'microelectronics',correct:'Transistors + Interconnects on One Chip',wrong:['Iron + Wood','Glass + Steam','Stone + Rope','Salt + Water']},
  'Microprocessor':{field:'computing hardware',correct:'CPU Logic + Registers + Control Unit',wrong:['Wheel + Magnet','Clay + Paper','Steam + Salt','Wood + Water']},
  'Digital Camera':{field:'digital imaging',correct:'Image Sensor + Lens + Processor',wrong:['Steam + Wheel','Stone + Rope','Copper + Salt','Clay + Magnet']},
  'Mobile Phone Prototype':{field:'mobile communication',correct:'Radio + Processor + Battery',wrong:['Stone + Fire','Wheel + Water','Glass + Rope','Salt + Magnet']},
  'Cellular Network':{field:'telecommunications',correct:'Base Stations + Radio Spectrum + Core Network',wrong:['Steam + Wheel','Clay + Fire','Stone + Paper','Magnet + Salt']},
  'Smartphone':{field:'mobile computing',correct:'Touchscreen + Processor + Wireless Network',wrong:['Wood + Steam','Stone + Magnet','Glass + Rope','Salt + Water']},
  'Touchscreen Device':{field:'human-computer interaction',correct:'Touch Sensor + Display + Controller',wrong:['Wheel + Fire','Clay + Steam','Stone + Wire','Paper + Magnet']},
  'GPS Navigator':{field:'satellite navigation',correct:'Satellite Signals + Receiver + Position Calculation',wrong:['Steam + Wheel','Magnet + Paper','Clay + Fire','Stone + Salt']},
  'Global Internet':{field:'network engineering',correct:'Routers + Fiber/Wireless Links + Protocols',wrong:['Wheel + Water','Stone + Heat','Clay + Magnet','Salt + Paper']},
  'Industrial Robot':{field:'robotics',correct:'Actuators + Sensors + Controller',wrong:['Stone + Rope','Steam + Clay','Paper + Magnet','Salt + Water']},
  'Machine Learning Model':{field:'machine learning',correct:'Data + Algorithm + Training Compute',wrong:['Wood + Fire','Glass + Stone','Magnet + Paper','Salt + Steam']},
  'AI Assistant':{field:'artificial intelligence',correct:'Language Model + Compute + Interface',wrong:['Wheel + Clay','Stone + Water','Paper + Magnet','Salt + Heat']},
  'Autonomous Car':{field:'autonomous systems',correct:'Sensors + Compute + Control + Vehicle',wrong:['Steam + Rope','Clay + Magnet','Paper + Salt','Stone + Fire']},
  'AI Research Lab':{field:'AI systems engineering',correct:'Data + Models + Compute + Evaluation',wrong:['Wheel + Water','Glass + Clay','Stone + Magnet','Wood + Salt']},
  'DNA Sequencer':{field:'molecular biotechnology',correct:'DNA Sample + Sequencing Chemistry + Detector',wrong:['Iron + Heat','Steam + Wheel','Paper + Magnet','Clay + Salt']},
  'mRNA Platform':{field:'biotechnology',correct:'mRNA Design + Lipid Delivery + Cell Uptake',wrong:['Stone + Fire','Copper + Water','Glass + Rope','Magnet + Salt']},
  'Medical Imaging AI':{field:'medical technology',correct:'Medical Images + AI Model + Validation',wrong:['Wood + Steam','Clay + Magnet','Paper + Water','Stone + Salt']},
  'Bionic Prosthetic':{field:'biomedical engineering',correct:'Sensors + Actuators + Control Interface',wrong:['Steam + Wheel','Glass + Fire','Stone + Paper','Magnet + Clay']},
  'Bioengineered Cell':{field:'synthetic biology',correct:'Genetic Design + Cellular Machinery + Delivery',wrong:['Iron + Water','Wheel + Steam','Paper + Salt','Stone + Magnet']},
  'Reusable Rocket':{field:'aerospace engineering',correct:'Propulsion + Guidance + Reentry System',wrong:['Wheel + Clay','Magnet + Paper','Stone + Water','Salt + Fire']},
  'Earth Observation Satellite':{field:'space systems',correct:'Satellite Bus + Sensors + Orbit',wrong:['Steam + Wheel','Clay + Rope','Paper + Magnet','Stone + Salt']},
  'Quantum Processor':{field:'quantum computing',correct:'Qubits + Control Hardware + Error Management',wrong:['Wood + Heat','Glass + Water','Stone + Rope','Magnet + Paper']},
  'Deep Space Probe':{field:'deep-space exploration',correct:'Spacecraft + Instruments + Communication + Propulsion',wrong:['Clay + Fire','Wheel + Salt','Paper + Magnet','Stone + Steam']},
  'Lunar Research Base':{field:'lunar engineering',correct:'Habitat + Power + Life Support + Communication',wrong:['Wood + Water','Glass + Magnet','Stone + Paper','Salt + Steam']},
  'Perovskite Solar Cell':{field:'solar energy',correct:'Perovskite Absorber + Electrodes + Charge Transport Layers',wrong:['Iron + Rope','Stone + Water','Steam + Magnet','Clay + Paper']},
  'Battery Grid':{field:'energy storage',correct:'Battery Modules + Power Electronics + Grid Control',wrong:['Wheel + Fire','Stone + Magnet','Glass + Salt','Wood + Steam']},
  'VR World':{field:'virtual reality',correct:'3D Software + Headset + Tracking System',wrong:['Clay + Heat','Stone + Water','Paper + Magnet','Salt + Wheel']},
  'Advanced Composite':{field:'advanced materials',correct:'High-Strength Fibers + Matrix Material',wrong:['Steam + Stone','Magnet + Paper','Clay + Water','Salt + Wood']},
  'Fusion Core':{field:'fusion energy',correct:'Fusion Plasma + Confinement + Heating',wrong:['Wheel + Clay','Stone + Salt','Paper + Magnet','Wood + Water']},
  'Multiverse Simulator':{field:'cosmological simulation',correct:'Physical Model + Compute + Simulation Rules',wrong:['Stone + Fire','Steam + Wheel','Glass + Salt','Magnet + Paper']},
  'Quantum Network':{field:'quantum networking',correct:'Quantum Nodes + Entanglement Links + Classical Control',wrong:['Clay + Water','Wood + Magnet','Stone + Rope','Salt + Fire']},
  'Synthetic World Engine':{field:'simulation engineering',correct:'World Model + Compute + Interaction Rules',wrong:['Wheel + Steam','Paper + Stone','Glass + Magnet','Salt + Wood']},
  'Cosmic Civilization':{field:'cosmic engineering',correct:'Energy Systems + Habitat + Communication + Automation',wrong:['Clay + Fire','Stone + Water','Magnet + Paper','Steam + Salt']},
  'Omniverse Gate':{field:'multiverse engineering',correct:'Quantum Interface + Simulation Engine + Stable Energy',wrong:['Wheel + Clay','Stone + Magnet','Paper + Water','Salt + Steam']}
};

const GAME_STAGE_BUILD_TARGETS={
  'Stone Age Foundations':['Fire','Stone Shelter','Stone Axe','Spear','Wheel','Pottery'],
  'Fire & Early Tools':['Bronze Tool','Iron Tool','Water Mill','Fire','Wheel','Pottery'],
  'Machines & Electricity':['Tesla Coil','Telegraph','Electric Motor','Radio','Early Computer'],
  'Computer Genesis':['Vacuum Tube Computer','Early Computer','Transistor','Integrated Circuit','Microprocessor','Digital Camera'],
  'Smartphone Era':['Mobile Phone Prototype','Cellular Network','Smartphone','Touchscreen Device','GPS Navigator','Global Internet'],
  'Robotics & AI':['Industrial Robot','Machine Learning Model','AI Assistant','Autonomous Car','AI Research Lab'],
  'Biotech & Medicine':['DNA Sequencer','mRNA Platform','Medical Imaging AI','Bionic Prosthetic','Bioengineered Cell'],
  'Space & Quantum':['Reusable Rocket','Earth Observation Satellite','Quantum Processor','Deep Space Probe','Lunar Research Base'],
  'Future Energy & Worlds':['Perovskite Solar Cell','Battery Grid','VR World','Advanced Composite','Fusion Core'],
  'Multiverse & Omniverse':['Multiverse Simulator','Quantum Network','Synthetic World Engine','Cosmic Civilization','Omniverse Gate']
};
...
function gameArtifactFor(level){
  ...
  const list=GAME_STAGE_BUILD_TARGETS[stage[0]]||[stage[4]];
  return list[(level-stage[1])%list.length];
}
function gameBuildMissionFor(level){
  const target=gameArtifactFor(level);
  const data=GAME_RECIPE_LIBRARY[target]||GAME_RECIPE_LIBRARY['Fire'];
  const raw=[data.correct,...data.wrong];
  const options=shuffle(raw,`recipe-${level}-${target}`);
  return {
    target,
    field:data.field,
    correct:data.correct,
    options,
    answerIndex:options.indexOf(data.correct),
    hint:`Choose the scientifically plausible recipe for ${target}.`
  };
}
function makeGameLevel(base,index){
  const stage=gameStageFor(index);
  const build=gameBuildMissionFor(index);
  return {
    id:`G${index}`,gameLevel:index,categoryKey:'game',subCategory:stage[0],subject:stage[0],
    baseQuestion:base.baseQuestion,question:base.question,options:build.options,answerIndex:build.answerIndex,
    answer:build.correct,hint:build.hint,artifact:build.target,difficulty:index<=150?'Easy':index<=300?'Medium':'Hard',
    gameStage:stage[0],gameDescription:stage[3],buildTarget:build.target,buildField:build.field,
    buildRecipe:build.correct,variant:0
  };
}
const GAME_LEVELS=[];
...
if(GAME_LEVELS.length!==GAME_TOTAL_LEVELS)throw new Error('Game mode must contain exactly 500 levels.');
if(GAME_LEVELS.some(x=>x.options.length!==5||x.answerIndex<0))throw new Error('Invalid game recipe mission.');
...
function showHint(){const q=currentQ(),box=document.getElementById('hintBox'),text=document.getElementById('hintText');if(!box||!text)return;const hint=state.gameMode?gameBuildMissionFor(state.gameLevel).hint:q.hint;text.textContent=state.language==='bn'?bnText(hint):hint;box.classList.add('show');document.getElementById('hintBtn').textContent=state.language==='bn'?'💡 HINT দেখা হয়েছে':'💡 HINT SHOWN'}
...
function render(){
 ...
 if(state.gameMode){
   const gm=gameBuildMissionFor(state.gameLevel);
   goal.innerHTML=`<span class="game-create-kicker">${state.language==='bn'?'তৈরি করো':'CREATE'}</span><strong class="game-create-target">${escapeHTML(gm.target)}</strong>`;
   if(missionSubtitle)missionSubtitle.innerHTML=`<span class="game-field-label">${state.language==='bn'?'ক্ষেত্র':'Field'}:</span> ${escapeHTML(gm.field)} • ${state.language==='bn'?'বৈজ্ঞানিকভাবে সঠিক recipe বেছে নাও':'Choose the scientifically valid recipe.'}`;
   opts.innerHTML=q.options.map((x,i)=>`<button class="option build-option" data-i="${i}"><span class="num">${state.language==='bn'?'অপশন':'OPTION'} ${i+1}</span><strong>${escapeHTML(String(x))}</strong></button>`).join('');
 }else{
   goal.innerHTML=`<span class="q-${state.language}">${escapeHTML(displayQuestion(q))}</span>`;
   if(missionSubtitle)missionSubtitle.textContent='Every correct answer fabricates a discovery.';
...
/* V18 FAIL-SAFE BOOT MARKER */
window.__ELEMENT_GAME_V18_READY=true;
